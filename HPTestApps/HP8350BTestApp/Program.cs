...
namespace HP8350BTestApp
{
    internal class Program
    {
        ...
        {
            HPDevices.HP8350B.Device signalGenerator = new HPDevices.HP8350B.Device(@"GPIB0::19::INSTR");
            HPDevices.HP53131A.Device frequencyCounter = new HPDevices.HP53131A.Device(@"GPIB0::23::INSTR");
            HPDevices.E4418B.Device powerMeter = new HPDevices.E4418B.Device(@"GPIB0::13::INSTR");
        ...
        private static void Measure(HPDevices.HP8350B.Device signalGenerator, HPDevices.HP53131A.Device frequencyCounter, HPDevices.E4418B.Device powerMeter, int frequency, int channel, bool saveToCSV = false, string csvFileName = "results.csv")
        {
